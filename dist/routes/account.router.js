...
router.patch("/", jwt_1.verifyToken, (0, multer_1.uploader)(1).fields([{ name: "imageFile", maxCount: 1 }]), profilePictureFilter_1.fileFilterProfile, account_controller_1.updateProfileController);
