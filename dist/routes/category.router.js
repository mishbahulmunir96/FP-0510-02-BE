...
router.delete("/category-property/:id", category_controller_1.deleteCategoryController);
router.patch("/category/:id", category_controller_1.updateCategoryController);
