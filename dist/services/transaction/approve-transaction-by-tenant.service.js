...
exports.approveTransactionByTenantService = void 0;
const nodemailer_1 = require("../../lib/nodemailer");
const prisma_1 = __importDefault(require("../../lib/prisma"));
const hbs = __importStar(require("handlebars"));
const fs = __importStar(require("fs"));
const path = __importStar(require("path"));
const approveTransactionByTenantService = (paymentId, tenantId, isApproved) => __awaiter(void 0, void 0, void 0, function* () {
...
exports.approveTransactionByTenantService = approveTransactionByTenantService;
