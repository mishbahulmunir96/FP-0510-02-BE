...
exports.confirmCheckOutService = void 0;
...
const confirmCheckOutService = (paymentId, tenantId) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const now = new Date();
        if (now < checkOutTime) {
            throw new Error("Check-out time has not started yet (starts at 9:00 WIB)");
        }
        ...
        const templatePath = path.join(__dirname, "../../templates/check-out-confirmed.hbs");
...
exports.confirmCheckOutService = confirmCheckOutService;
